...
public class MenuDrivenEgHashMap {
        ...
        do
        {
            ...
            switch(choice)
            {
                case 1: System.out.println("ENTER ACCOUNT DETAILS");
                        ...
                        hm.put(accno, acc);
                        System.out.println("MESSAGE: Account Created USER-"+name);

                        break;
                case 2: System.out.print("Enter Acc. Number: ");
                        accno=sc.nextLine();
                        hm.remove(accno);
                        break;
                case 3: System.out.print("Enter Acc. Number: ");
                        accno=sc.nextLine();
                        acc=hm.get(accno);
                        System.out.println(acc);
                        break;
